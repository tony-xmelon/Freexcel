...
Mainline observed: `origin/main` at `a35cec8b3`  
...
| --- | ---: |
| Tracked files | 1,858 |
| C# source files under `src/` | 884 |
| C# test files under `tests/` | 370 |
| Markdown docs under `docs/` | 224 |
| Source lines under `src/` | 159,886 |
| Test lines under `tests/` | 138,994 |
| Documentation lines under `docs/` | 26,308 |
| Test methods marked `[Fact]` / `[Theory]` | 5,963 |
...
| Item | Status |
| --- | --- |
| Mainline | `origin/main` at `a35cec8b3` before this docs-branch consolidation merge |
