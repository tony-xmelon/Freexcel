...
| Structured tables (load/save; native parts retained) | Partial | Metadata, style flags, totals-row labels/functions, authored table parts, and native references are retained; full Excel table formula/filter semantics deferred |
