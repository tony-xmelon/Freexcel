...
| Generated deterministic known-gap fixtures | 14 | Declared with expected warnings and notes; warning detector covers unsupported chart package parts, conditional formats, drawing objects, sparklines, VBA macros, PivotTables/pivot caches, Power Query, Data Model/Power Pivot, slicers, timelines, external links, embedded objects, and custom XML |
...
| Generated known-gap warning/notes coverage | 14/14 pass |
| Generated known-gap package warning execution | 14/14 pass |
| Unsupported feature detector known-gap coverage | Unsupported chart package parts, conditional formats, drawing objects, sparklines, VBA macros, PivotTables/pivot caches, Power Query, Data Model/Power Pivot, slicers, timelines, external links, embedded objects, and custom XML detected, including multiple unsupported worksheet/package feature families |
...
Result: 4/4 corpus runner tests passing over 24 manifest rows. Full solution verification is 2039/2039 tests passing with 0 build warnings.
