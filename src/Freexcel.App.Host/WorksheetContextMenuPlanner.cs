...
public static class WorksheetContextMenuPlanner
{
    ...
    [
        ...
        new("Define Name...", WorksheetContextMenuAction.DefineName),
        new("Create Table...", WorksheetContextMenuAction.CreateTable),
        new("Format as Table...", WorksheetContextMenuAction.FormatAsTable),
        new("Text to Columns...", WorksheetContextMenuAction.TextToColumns),
        new("Remove Duplicates...", WorksheetContextMenuAction.RemoveDuplicates),
        new("Data Validation...", WorksheetContextMenuAction.DataValidation),
        WorksheetContextMenuCommand.Separator,
        ...
        WorksheetContextMenuCommand.Separator,
        new("New Comment", WorksheetContextMenuAction.NewComment),
