...
| Protection, calculation, page setup, and worksheet view/what-if metadata | `generated-protection-page-setup-001` plus workbook calculation-property, `customSheetViews`, and scenario smoke tests |
