...
public sealed class MainWindowUiaPropertiesTests
{
    ...
    {
        var document = LoadMainWindowXaml();
        XNamespace ui = "clr-namespace:Freexcel.App.UI;assembly=Freexcel.App.UI";
        XNamespace x = "http://schemas.microsoft.com/winfx/2006/xaml";
    ...
    public void GridView_OverridesOnCreateAutomationPeerForScreenReaderSupport()
    {
        var source = File.ReadAllText(
            WorkspaceFileLocator.Find("src", "Freexcel.App.UI", "GridView.cs"));
    ...
    private static XDocument LoadMainWindowXaml() =>
        XDocument.Load(WorkspaceFileLocator.Find("src", "Freexcel.App.Host", "MainWindow.xaml"));
}
