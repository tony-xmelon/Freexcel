...
| UI | F10 | Partial | Enters Freexcel ribbon keytip mode; badges are centered near the lower edge of ribbon targets and clamped inside the overlay; pixel-perfect Excel keytip overlay placement remains partial under the broader ribbon keytip row. |
