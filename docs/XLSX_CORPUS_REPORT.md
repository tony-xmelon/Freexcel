...
| Public redistributed workbooks | 25 | Open-license Tealeg XLSX public corpus; files open, save, and reload through the runner with tag assertions for hyperlinks, merged cells, sheet-name boundaries, inline/shared strings, mixed cell types, and retained package structures for styles, hyperlinks, merged cells, inline strings, mixed cell types, and chartsheets |
...
| Public workbook corpus | 25/25 public/open-license Tealeg workbooks open, save, reload, pass saved-package health validation, retain model-visible workbook summaries, satisfy tag-level semantic assertions where applicable, preserve checked package structures for public styles/hyperlinks/merged cells/inline strings/mixed cell types/chartsheets after ordinary model edits, and execute warning detection for present public rows tagged with unsupported surfaces |
...
| Generated supported-metadata-pass workbooks | 46 | 46 | 100% |
...
| Public real-world workbook structures | 25 Tealeg workbooks open, save, reload, retain model-visible workbook summaries, pass package-health checks, preserve checked package structures for styles/hyperlinks/merged cells/inline strings/mixed cell types/chartsheets after ordinary model edits, and run real-file warning detection for unsupported-tag rows | 100% |
...
| Formatting, style-only blank cells, themes, and document metadata | `generated-formatting-001`, `generated-style-only-cells-002`, plus workbook theme native-scheme, stylesheet native metadata, and document-property smoke tests |
