...
`407`, `409`, `40A`, `40B`, `40C`, `40E`, `410`, `411`, `412`, `413`, `414`, `415`, `416`, `419`, `41D`, `41F`, `422`, `804`, `807`, `809`, `80A`, `813`, `816`, `100A`, `C04`, `C09`, `C0C`, `C0A`, `1009`, `100C`, `1409`, `140A`, `1809`, `180A`, `1C09`, `1C0A`, `200A`, `240A`, `280A`, `2C0A`, `300A`, `340A`, `380A`, `3C0A`, `400A`, `4009`, `440A`, and `500A` to deterministic decimal/group/date separators without depending on the user's OS culture. The catalog can also carry non-Western group-size patterns, currently used for Indian grouping under `4009` (`en-IN`). The table-driven catalog deliberately stores resolved separators and group sizes rather than calling OS culture services during rendering, keeping workbook display deterministic across machines. The default indexed custom-format palette maps `Color1` through `Color56`; workbook
