...
| Export to PDF/XPS | Partial | Deterministic active-sheet PDF export uses the existing print renderer and PDFsharp-WPF raster pages; XPS export remains available with explicit option summary; full Excel PDF publish options remain partial |
| Close | Implemented | |
