...
| Formulas | Ctrl+[ / Ctrl+] | Partial | Selects same-sheet direct precedents / dependents for the active cell. Cross-sheet selection and Ctrl+Shift all-level traversal remain pending. |
