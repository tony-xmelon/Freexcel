...
Mainline observed: `origin/main` at `55b1da4a0`  
...
| --- | ---: |
| Tracked files | 1,856 |
| C# source files under `src/` | 882 |
| C# test files under `tests/` | 370 |
| Markdown docs under `docs/` | 224 |
| Source lines under `src/` | 159,799 |
| Test lines under `tests/` | 138,868 |
| Documentation lines under `docs/` | 26,306 |
| Test methods marked `[Fact]` / `[Theory]` | 5,957 |
...
| Item | Status |
| --- | --- |
| Mainline | `origin/main` at `55b1da4a0` before this docs-branch consolidation merge |
