...
single-column transforms including dotted/underscored/hyphenated email display-name cleanup, plus a small multi-column pattern set, and returns no result when the examples are ambiguous.
