...
**Historical baseline at plan creation:** 214 documented Excel functions implemented, 95 in-scope functions remaining. The current baseline is 343/343 in-scope functions implemented; excluded cloud/cube/service functions remain outside scope unless a design decision changes that.
