...
public sealed class SelectDataSourceDialog : Window
{
    ...
    private static StackPanel AddEditRemoveButtons()
    {
        ...
        stack.Children.Add(new Button { Content = "_Add", Width = 74, Margin = new Thickness(0, 0, 0, 4) });
        stack.Children.Add(new Button { Content = "_Edit", Width = 74, Margin = new Thickness(0, 0, 0, 4) });
        stack.Children.Add(new Button { Content = "_Remove", Width = 74 });
        return stack;
    }
}
