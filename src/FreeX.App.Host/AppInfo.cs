...
public static class AppInfo
{
    ...
    public const string SourceNotice = "Full legal, privacy, and third-party license texts are maintained with the FreeX release materials at https://github.com/tony-xmelon/FreeX.";
