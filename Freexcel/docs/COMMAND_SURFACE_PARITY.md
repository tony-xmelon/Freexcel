...
| Flash Fill | Partial | Expanded deterministic inference including common first-name/last-name contact patterns, shared-domain email generation, and first-initial email aliases; Excel's full ML-like inference remains partial |
...
| Flash Fill (Data tab) | Partial | Expanded deterministic inference including common first-name/last-name contact patterns, shared-domain email generation, and first-initial email aliases; Excel's full ML-like inference remains partial |
