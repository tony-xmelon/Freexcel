...
| UI | Shift+F10 / Menu key | Partial | Opens the worksheet context menu with clipboard, insert/delete, sort, filter, note, hyperlink, format-cells, clear-formats, and clear-content actions. Full Excel context-menu contents remain partial. |
