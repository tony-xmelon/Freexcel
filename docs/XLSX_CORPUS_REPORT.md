...
| Generated deterministic supported-metadata-pass fixtures | 11 | Slicers, timelines, external workbook links, printer settings, calc chains, stable document properties, header/footer legacy drawings, workbook extension lists, worksheet ignored errors, worksheet cell watches, and custom XML parts retain native package references after ordinary edits |
...
| Generated metadata-pass package retention after model edit | 11/11 pass for critical package parts, retained relationship targets/details, critical content-type overrides, no unsupported-feature warnings, and saved-package health validation |
...
| Generated supported-metadata-pass workbooks | 11 | 11 | 100% |
