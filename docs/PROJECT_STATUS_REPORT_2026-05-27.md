...
| C# test files under `tests/` | 385 |
| Markdown docs under `docs/` | 225 |
| Source lines under `src/` | 162,626 |
| Test lines under `tests/` | 145,407 |
| Documentation lines under `docs/` | 26,470 |
| Test methods marked `[Fact]` / `[Theory]` | 6,211 |
