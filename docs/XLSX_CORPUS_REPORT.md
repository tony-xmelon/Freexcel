...
| Generated deterministic supported-metadata-pass fixtures | 16 | Slicers, timelines, external workbook links, printer settings, calc chains, stable document properties, header/footer legacy drawings, workbook extension lists, worksheet ignored errors, worksheet cell watches, worksheet phonetic properties, worksheet sort state, worksheet data consolidation, worksheet custom properties, worksheet smart tags, and custom XML parts retain native package references after ordinary edits |
...
| Generated metadata-pass package retention after model edit | 16/16 pass for critical package parts, retained relationship targets/details, critical content-type overrides, no unsupported-feature warnings, and saved-package health validation |
...
| Generated supported-metadata-pass workbooks | 16 | 16 | 100% |
