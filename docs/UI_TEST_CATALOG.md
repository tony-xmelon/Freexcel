...
| UI-CMD-HOME-FONT-001 | UI-CAT-HOME-002 | Font family/size/grow/shrink | Font size dropdown and typed Enter keyboard commits share the same positive-size parser and style application path; mouse dropdowns, broader keyboard traversal, grid render, style model, saved reload, and grow/shrink evidence remain to be closed out. | In Progress |
