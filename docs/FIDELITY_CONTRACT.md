...
| Advanced chart families (surface/treemap/waterfall/etc.) | Partial | Combo/radar/stock, 2D/3D surface, histogram/Pareto, waterfall, treemap, sunburst, box-whisker, and funnel charts have package and rendering paths; map charts are recognized as deferred models when their package parts are parseable, while unparseable or unsupported chart parts still use the unsupported-feature warning path; deeper authoring/editing polish and lossless mixed drawing-part writing remain partial |
