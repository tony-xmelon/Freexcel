...
| UI-CAT-CONTEXT-002B | UI-CAT-CONTEXT-002 | Sheet-tab commands | Add, rename, duplicate, delete, move, tab color, hide/unhide, select all, ungroup, active-tab F6 focus and Shift+F10/Menu-key context entry. | In Progress |
...
| UI-CMD-SHEET-002 | UI-CAT-CONTEXT-002 | Sheet-tab pointer/keyboard operations | Click, Ctrl/Shift group, drag reorder, double-click rename, scroll arrows, Ctrl+PageUp/PageDown, F6 active-tab focus, Shift+F10/Menu key. | In Progress |
