...
| Protection, calculation, page setup, and worksheet/workbook view/what-if metadata | `generated-protection-page-setup-001` plus workbook calculation-property, `customSheetViews`, scenario, and workbook `extLst` smoke tests |
