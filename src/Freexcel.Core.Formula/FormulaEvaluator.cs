...
public sealed class FormulaEvaluator
{
    ...
    private static readonly HashSet<string> StructuredRangeFunctions = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        "COMPLEX", "DELTA", "ERF", "ERF.PRECISE", "ERFC", "ERFC.PRECISE", "GESTEP", "IMABS", "IMAGINARY", "IMCONJUGATE", "IMCOS", "IMCOSH", "IMDIV", "IMEXP", "IMLN", "IMLOG10", "IMLOG2", "IMPRODUCT", "IMREAL", "IMSIN", "IMSINH", "IMSQRT", "IMSUB", "IMSUM",
        "CONVERT",
