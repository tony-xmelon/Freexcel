...
Mainline observed: `origin/main` at `f05a8f34f`  
...
| --- | ---: |
| Tracked files | 1,860 |
| C# source files under `src/` | 886 |
| C# test files under `tests/` | 370 |
| Markdown docs under `docs/` | 224 |
| Source lines under `src/` | 160,035 |
| Test lines under `tests/` | 139,272 |
| Documentation lines under `docs/` | 26,311 |
| Test methods marked `[Fact]` / `[Theory]` | 5,973 |
...
| Item | Status |
| --- | --- |
| Mainline | `origin/main` at `f05a8f34f` before this docs-branch consolidation merge |
