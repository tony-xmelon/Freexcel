...
| Flash Fill | Partial | Expanded deterministic inference including common first-name/last-name contact patterns, shared-domain email generation, and first-initial email aliases; full Excel inference partial |
