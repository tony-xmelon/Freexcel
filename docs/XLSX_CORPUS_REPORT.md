...
| Public workbook corpus | 25/25 public/open-license Tealeg workbooks open, save, reload, pass saved-package health validation, retain model-visible workbook summaries, satisfy tag-level semantic assertions where applicable, preserve checked package structures for public styles/hyperlinks/merged cells/inline strings/mixed cell types/chartsheets, and execute warning detection for present public rows tagged with unsupported surfaces |
...
| Public real-world workbook structures | 25 Tealeg workbooks open, save, reload, retain model-visible workbook summaries, pass package-health checks, preserve checked package structures for styles/hyperlinks/merged cells/inline strings/mixed cell types/chartsheets, and run real-file warning detection for unsupported-tag rows | 100% |
