...
| UI-CMD-WCM-004 | UI-CAT-CONTEXT-001 | Worksheet context row/column group | Planner coverage proves access-key headers for Hide/Unhide Rows, Row Height, AutoFit Row Height, Hide/Unhide Columns, Column Width, and AutoFit Column Width; remaining work is live keyboard command mutation and target-specific disabled states. | In Progress |
