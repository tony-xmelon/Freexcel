...
public partial class FileAdapterSmokeTests
{
    ...
    [Fact]
    public void XlsxAdapter_Save_WritesEmbeddedChartAxisTickLabelPositionPackagePart()
    {
        var workbook = new Workbook("ChartAxisTickLabelPositionPackageSave");
        var sheet = workbook.AddSheet("Sheet1");
        sheet.SetCell(new CellAddress(sheet.Id, 1, 1), new TextValue("Month"));
        sheet.SetCell(new CellAddress(sheet.Id, 1, 2), new TextValue("Sales"));
        sheet.SetCell(new CellAddress(sheet.Id, 2, 1), new TextValue("Jan"));
        ...
        {
            Type = ChartType.Column,
            XAxisTickLabelPosition = ChartAxisTickLabelPosition.Low,
            YAxisTickLabelPosition = ChartAxisTickLabelPosition.High,
            DataRange = new GridRange(
                new CellAddress(sheet.Id, 1, 1),
                new CellAddress(sheet.Id, 4, 2))
        });
        ...
        var loaded = new XlsxFileAdapter().Load(saved);
        var loadedChart = loaded.GetSheetAt(0).Charts.Should().ContainSingle().Subject;
        loadedChart.XAxisTickLabelPosition.Should().Be(ChartAxisTickLabelPosition.Low);
        loadedChart.YAxisTickLabelPosition.Should().Be(ChartAxisTickLabelPosition.High);
    }
    ...
    [Fact]
    public void XlsxAdapter_SaveLoadedWorkbook_PreservesEmbeddedChartDataLabelCustomNumberFormatPackagePart()
    {
        var workbook = new Workbook("ChartDataLabelCustomNumberFormatPackagePreserve");
        var sheet = workbook.AddSheet("Sheet1");
        sheet.SetCell(new CellAddress(sheet.Id, 1, 1), new TextValue("Month"));
        sheet.SetCell(new CellAddress(sheet.Id, 1, 2), new TextValue("Sales"));
        sheet.SetCell(new CellAddress(sheet.Id, 2, 1), new TextValue("Jan"));
        ...
        var loaded = adapter.Load(source);
        var loadedChart = loaded.GetSheetAt(0).Charts.Should().ContainSingle().Subject;
        loadedChart.DataLabelNumberFormatCode.Should().Be("#,##0.0 \"kg\"");
        loadedChart.DataLabelNumberFormatSourceLinked.Should().BeFalse();
        ...
        XNamespace chartNs = "http://schemas.openxmlformats.org/drawingml/2006/chart";
        var chartXml = LoadPackageXml(archive.GetEntry("xl/charts/chart1.xml")!);
        var numberFormat = chartXml.Descendants(chartNs + "dLbls").Single().Element(chartNs + "numFmt")!;
        numberFormat.Attribute("formatCode")!.Value.Should().Be("#,##0.0 \"kg\"");
    ...
    [Fact]
    public void XlsxAdapter_SaveLoadedWorkbook_PreservesEmbeddedChartPointDataLabelShowFlagsPackagePart()
    {
        var workbook = new Workbook("ChartPointDataLabelShowFlagsPackagePreserve");
        var sheet = workbook.AddSheet("Sheet1");
        sheet.SetCell(new CellAddress(sheet.Id, 1, 1), new TextValue("Month"));
        sheet.SetCell(new CellAddress(sheet.Id, 1, 2), new TextValue("Sales"));
        sheet.SetCell(new CellAddress(sheet.Id, 2, 1), new TextValue("Jan"));
        ...
        var loadedChart = loaded.GetSheetAt(0).Charts.Should().ContainSingle().Subject;
        loadedChart.PointDataLabelFormats.Should().ContainSingle().Which.Should().Be(
            new ChartPointDataLabelFormat(0, 1, ShowValue: false, ShowCategoryName: true, ShowSeriesName: true));
        ...
        var chartXml = LoadPackageXml(archive.GetEntry("xl/charts/chart1.xml")!);
        var label = chartXml.Descendants(chartNs + "dLbl").Should().ContainSingle().Subject;
        label.Element(chartNs + "showVal")!.Attribute("val")!.Value.Should().Be("0");
        label.Element(chartNs + "showCatName")!.Attribute("val")!.Value.Should().Be("1");
        label.Element(chartNs + "showSerName")!.Attribute("val")!.Value.Should().Be("1");
    }

    [Fact]
    public void XlsxAdapter_SaveLoadedWorkbook_PreservesEmbeddedChartPointDataLabelNumberFormatAndSeparatorPackagePart()
    {
        var workbook = new Workbook("ChartPointDataLabelNumberFormatPackagePreserve");
        var sheet = workbook.AddSheet("Sheet1");
        sheet.SetCell(new CellAddress(sheet.Id, 1, 1), new TextValue("Month"));
        sheet.SetCell(new CellAddress(sheet.Id, 1, 2), new TextValue("Sales"));
        sheet.SetCell(new CellAddress(sheet.Id, 2, 1), new TextValue("Jan"));
        ...
        numberFormat.Attribute("formatCode")!.Value.Should().Be("#,##0.0 \"kg\"");
        numberFormat.Attribute("sourceLinked")!.Value.Should().Be("0");
        label.Element(chartNs + "separator")!.Value.Should().Be(" | ");
    }
    ...
    [Fact]
    public void XlsxAdapter_SaveLoadedWorkbook_PreservesEmbeddedChartTrendlineLabelNumberFormatPackagePart()
    {
        var workbook = new Workbook("ChartTrendlineLabelPackagePreserve");
        var sheet = workbook.AddSheet("Sheet1");
        sheet.SetCell(new CellAddress(sheet.Id, 1, 1), new TextValue("Month"));
        sheet.SetCell(new CellAddress(sheet.Id, 1, 2), new TextValue("Sales"));
        sheet.SetCell(new CellAddress(sheet.Id, 2, 1), new TextValue("Jan"));
        ...
        var loaded = adapter.Load(source);
        var loadedChart = loaded.GetSheetAt(0).Charts.Should().ContainSingle().Subject;
        loadedChart.TrendlineLabelNumberFormatCode.Should().Be("0.000E+00");
        loadedChart.TrendlineLabelNumberFormatSourceLinked.Should().BeFalse();
        ...
        XNamespace chartNs = "http://schemas.openxmlformats.org/drawingml/2006/chart";
        var chartXml = LoadPackageXml(archive.GetEntry("xl/charts/chart1.xml")!);
        var numberFormat = chartXml.Descendants(chartNs + "trendlineLbl")
            .Should()
            .ContainSingle()
            .Subject
            .Element(chartNs + "numFmt")!;
    ...
    [Fact]
    public void XlsxAdapter_Save_WritesEmbeddedChartCategoryAxisMultiLevelLabelPackagePart()
    {
        var workbook = new Workbook("ChartCategoryAxisLabelPackageSave");
        var sheet = workbook.AddSheet("Sheet1");
        ...
        using (var archive = new ZipArchive(saved, ZipArchiveMode.Read, leaveOpen: true))
        {
            ...
            categoryAxis.Element(chartNs + "noMultiLvlLbl")!.Attribute("val")!.Value.Should().Be("1");
        }

        saved.Position = 0;
        var loaded = new XlsxFileAdapter().Load(saved);
        var loadedChart = loaded.GetSheetAt(0).Charts.Should().ContainSingle().Subject;
        loadedChart.XAxisNoMultiLevelLabels.Should().BeTrue();
    }

    [Fact]
    public void XlsxAdapter_Save_WritesEmbeddedChartCategoryAxisLabelAlignmentPackagePart()
    {
        var workbook = new Workbook("ChartCategoryAxisAlignmentPackageSave");
        var sheet = workbook.AddSheet("Sheet1");
        sheet.SetCell(new CellAddress(sheet.Id, 1, 1), new TextValue("Month"));
        sheet.SetCell(new CellAddress(sheet.Id, 1, 2), new TextValue("Sales"));
        sheet.SetCell(new CellAddress(sheet.Id, 2, 1), new TextValue("Jan"));
        ...
        {
            Type = ChartType.Column,
            XAxisLabelAlignment = ChartAxisLabelAlignment.Right,
            DataRange = new GridRange(
                new CellAddress(sheet.Id, 1, 1),
                new CellAddress(sheet.Id, 4, 2))
        });
        ...
        using (var archive = new ZipArchive(saved, ZipArchiveMode.Read, leaveOpen: true))
        {
            ...
            XNamespace chartNs = "http://schemas.openxmlformats.org/drawingml/2006/chart";
            var categoryAxis = chartXml.Descendants(chartNs + "catAx").Single();
            categoryAxis.Element(chartNs + "lblAlgn")!.Attribute("val")!.Value.Should().Be("r");
        }

        saved.Position = 0;
        var loaded = new XlsxFileAdapter().Load(saved);
        var loadedChart = loaded.GetSheetAt(0).Charts.Should().ContainSingle().Subject;
        loadedChart.XAxisLabelAlignment.Should().Be(ChartAxisLabelAlignment.Right);
    }
    ...
    [Fact]
    public void XlsxAdapter_Save_WritesEmbeddedChartValueAxisDisplayUnitPackagePart()
    {
        var workbook = new Workbook("ChartAxisDisplayUnitPackageSave");
        var sheet = workbook.AddSheet("Sheet1");
        sheet.SetCell(new CellAddress(sheet.Id, 1, 1), new TextValue("Month"));
        sheet.SetCell(new CellAddress(sheet.Id, 1, 2), new TextValue("Sales"));
        sheet.SetCell(new CellAddress(sheet.Id, 2, 1), new TextValue("Jan"));
        sheet.SetCell(new CellAddress(sheet.Id, 3, 1), new TextValue("Feb"));
        sheet.SetCell(new CellAddress(sheet.Id, 4, 1), new TextValue("Mar"));
        sheet.SetCell(new CellAddress(sheet.Id, 2, 2), new NumberValue(1_000_000));
        sheet.SetCell(new CellAddress(sheet.Id, 3, 2), new NumberValue(2_000_000));
        sheet.SetCell(new CellAddress(sheet.Id, 4, 2), new NumberValue(3_000_000));
        sheet.Charts.Add(new ChartModel
        {
            Type = ChartType.Column,
        ...
        using (var archive = new ZipArchive(saved, ZipArchiveMode.Read, leaveOpen: true))
        {
            ...
            XNamespace chartNs = "http://schemas.openxmlformats.org/drawingml/2006/chart";
            var valueAxis = chartXml.Descendants(chartNs + "valAx").Single();
            valueAxis.Element(chartNs + "dispUnits")!
                .Element(chartNs + "builtInUnit")!
                .Attribute("val")!
                .Value.Should().Be("millions");
        }
    ...
    [Fact]
    public void XlsxAdapter_Save_WritesEmbeddedChartAxisCrossingMetadataPackagePart()
    {
        var workbook = new Workbook("ChartAxisCrossingPackageSave");
        var sheet = workbook.AddSheet("Sheet1");
        sheet.SetCell(new CellAddress(sheet.Id, 1, 1), new TextValue("Month"));
        sheet.SetCell(new CellAddress(sheet.Id, 1, 2), new TextValue("Sales"));
        sheet.SetCell(new CellAddress(sheet.Id, 2, 1), new TextValue("Jan"));
        ...
        using (var archive = new ZipArchive(saved, ZipArchiveMode.Read, leaveOpen: true))
        {
            ...
            XNamespace chartNs = "http://schemas.openxmlformats.org/drawingml/2006/chart";
            var valueAxis = chartXml.Descendants(chartNs + "valAx").Single();
            valueAxis.Element(chartNs + "crosses").Should().BeNull();
            valueAxis.Element(chartNs + "crossesAt")!.Attribute("val")!.Value.Should().Be("5");
        ...
        var loaded = new XlsxFileAdapter().Load(saved);
        var loadedChart = loaded.GetSheetAt(0).Charts.Should().ContainSingle().Subject;
        loadedChart.YAxisCrosses.Should().Be(ChartAxisCrosses.Custom);
        loadedChart.YAxisCrossesAt.Should().Be(5);
        loadedChart.YAxisCrossBetween.Should().Be(ChartAxisCrossBetween.MidCategory);
    }
    ...
    [Fact]
    public void XlsxAdapter_SaveLoadedWorkbook_PreservesChartCustomErrorBarReferences()
    {
        var workbook = new Workbook("ChartCustomErrorBarsPackagePreserve");
        var sheet = workbook.AddSheet("Sheet1");
        sheet.SetCell(new CellAddress(sheet.Id, 1, 1), new TextValue("Month"));
        sheet.SetCell(new CellAddress(sheet.Id, 1, 2), new TextValue("Sales"));
        sheet.SetCell(new CellAddress(sheet.Id, 1, 3), new TextValue("Plus"));
        sheet.SetCell(new CellAddress(sheet.Id, 1, 4), new TextValue("Minus"));
        sheet.SetCell(new CellAddress(sheet.Id, 2, 1), new TextValue("Jan"));
        sheet.SetCell(new CellAddress(sheet.Id, 3, 1), new TextValue("Feb"));
        sheet.SetCell(new CellAddress(sheet.Id, 4, 1), new TextValue("Mar"));
        sheet.SetCell(new CellAddress(sheet.Id, 2, 2), new NumberValue(10));
        ...
        sheet.SetCell(new CellAddress(sheet.Id, 4, 3), new NumberValue(3));
        sheet.SetCell(new CellAddress(sheet.Id, 2, 4), new NumberValue(0.5));
        sheet.SetCell(new CellAddress(sheet.Id, 3, 4), new NumberValue(1.5));
        sheet.SetCell(new CellAddress(sheet.Id, 4, 4), new NumberValue(2.5));
                  ...
                  <c:barChart>
                    ...
                    <c:ser>
                      ...
                      <c:errBars>
                        ...
                        <c:plus><c:numRef><c:f>Sheet1!$C$2:$C$4</c:f></c:numRef></c:plus>
                        <c:minus><c:numRef><c:f>Sheet1!$D$2:$D$4</c:f></c:numRef></c:minus>
                      </c:errBars>
                    </c:ser>
                  </c:barChart>
                </c:plotArea>
        ...
        var loaded = adapter.Load(source);
        var loadedChart = loaded.GetSheetAt(0).Charts.Should().ContainSingle().Subject;
        loadedChart.ErrorBarKind.Should().Be(ChartErrorBarKind.Custom);
        loadedChart.ErrorBarPlusRangeFormula.Should().Be("Sheet1!$C$2:$C$4");
        loadedChart.ErrorBarMinusRangeFormula.Should().Be("Sheet1!$D$2:$D$4");
        ...
        errorBars.Element(chartNs + "errValType")!.Attribute("val")!.Value.Should().Be("cust");
        errorBars.Element(chartNs + "plus")!.Descendants(chartNs + "f").Single().Value.Should().Be("Sheet1!$C$2:$C$4");
        errorBars.Element(chartNs + "minus")!.Descendants(chartNs + "f").Single().Value.Should().Be("Sheet1!$D$2:$D$4");
    }
    ...
    public void XlsxAdapter_SaveLoadedWorkbook_PreservesChartErrorBarAxisDirection()
    {
        ...
        var loaded = adapter.Load(source);
        var loadedChart = loaded.GetSheetAt(0).Charts.Should().ContainSingle().Subject;
        loadedChart.ErrorBarAxisDirection.Should().Be(ChartErrorBarAxisDirection.X);
        ...
        XNamespace chartNs = "http://schemas.openxmlformats.org/drawingml/2006/chart";
        var chartXml = LoadPackageXml(archive.GetEntry("xl/charts/chart1.xml")!);
        chartXml.Descendants(chartNs + "errBars")
            .Single()
            .Element(chartNs + "errDir")!
            .Attribute("val")!
            .Value
            .Should()
            .Be("x");
    ...
    public void XlsxAdapter_Save_WritesLineChartGuideMetadata()
    {
        ...
        upDownBars.Element(chartNs + "gapWidth")!.Attribute("val")!.Value.Should().Be("180");
        var upBarsShape = upDownBars.Element(chartNs + "upBars")!.Element(chartNs + "spPr")!;
        upBarsShape.Element(drawingNs + "solidFill")!.Element(drawingNs + "srgbClr")!.Attribute("val")!.Value.Should().Be("70AD47");
        var upBarsLine = upBarsShape.Element(drawingNs + "ln")!;
        upBarsLine.Attribute("w")!.Value.Should().Be("12700");
        upBarsLine.Element(drawingNs + "solidFill")!.Element(drawingNs + "srgbClr")!.Attribute("val")!.Value.Should().Be("548235");

        var downBarsShape = upDownBars.Element(chartNs + "downBars")!.Element(chartNs + "spPr")!;
        downBarsShape.Element(drawingNs + "solidFill")!.Element(drawingNs + "srgbClr")!.Attribute("val")!.Value.Should().Be("C00000");
        var downBarsLine = downBarsShape.Element(drawingNs + "ln")!;
        downBarsLine.Attribute("w")!.Value.Should().Be("25400");
        downBarsLine.Element(drawingNs + "solidFill")!.Element(drawingNs + "schemeClr")!.Attribute("val")!.Value.Should().Be("accent2");
    }
    ...
    public void XlsxAdapter_Save_WritesAuthoredPivotTablePackageParts()
    {
        ...
        using (var archive = new ZipArchive(saved, ZipArchiveMode.Read, leaveOpen: true))
        {
            ...
            pivotXml.Root!.Attribute("applyNumberFormats")!.Value.Should().Be("0");
            pivotXml.Root!.Attribute("applyBorderFormats")!.Value.Should().Be("0");
            pivotXml.Root!.Attribute("applyFontFormats")!.Value.Should().Be("0");
            pivotXml.Root!.Attribute("applyPatternFormats")!.Value.Should().Be("0");
        ...
        loadedPivot.ApplyNumberFormats.Should().BeFalse();
        loadedPivot.ApplyBorderFormats.Should().BeFalse();
        loadedPivot.ApplyFontFormats.Should().BeFalse();
        loadedPivot.ApplyPatternFormats.Should().BeFalse();
