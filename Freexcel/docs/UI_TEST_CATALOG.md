...
| UI-CMD-HOME-EDIT-005 | UI-CAT-HOME-004 | Go To dialog history and navigation targets | Cover Ctrl+G/F5, Home > Find & Select > Go To, named ranges, sheet-qualified refs, invalid refs, Go To Special first-choice focus, history persistence in-session, OK/Cancel/Escape, and active selection/focus proof. | In Progress |
