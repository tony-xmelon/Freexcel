...
- PivotTable functional core is implemented, including creation, refresh, field layout/source/options changes, filtering/grouping/sorting, Show Values As, calculated fields/items, GETPIVOTDATA, Show Details, PivotChart sync, slicer/timeline integration, and external/OLAP pivot-cache source metadata load/save. Remaining gaps are deeper PivotStyle gallery semantics, full PivotChart layout/design editing, and external/OLAP/data-model refresh or execution.
