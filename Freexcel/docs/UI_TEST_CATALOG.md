...
| UI-CAT-HOME-004 | Cells/editing | Insert/delete cells/rows/columns/sheets, hide/unhide, row height with default input focus, column width, AutoFit, Clear, Fill, Flash Fill, Sort/Filter, Find/Replace/Go To. | Mouse, shortcuts, keytips, dialog access keys, context menu. | Rows, columns, formulas, notes, hyperlinks, filtered ranges, contact-pattern Flash Fill data. | Correct command route, visible sheet mutation, undo/redo/F4 repeat, dialog focus return. | In Progress |
