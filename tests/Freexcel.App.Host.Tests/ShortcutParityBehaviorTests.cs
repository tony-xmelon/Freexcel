...
public sealed class ShortcutParityBehaviorTests
{
    ...
    public void PrintSettingsPanel_ExposesOrientationPaperSizeMarginsAndScalingControls()
    {
        var source = File.ReadAllText(
            WorkspaceFileLocator.Find("src", "Freexcel.App.Host", "PrintPreviewSettingsPanelFactory.cs"));
    ...
    {
        var source = File.ReadAllText(
            WorkspaceFileLocator.Find("src", "Freexcel.App.Host", "PrintSettingsPlanner.cs"));
    ...
    {
        var source = File.ReadAllText(
            WorkspaceFileLocator.Find("src", "Freexcel.App.Host", "FormatCellsDialog.xaml.cs"));
    ...
    {
        var source = File.ReadAllText(
            WorkspaceFileLocator.Find("src", "Freexcel.App.Host", "ThreadedCommentDialog.cs"));
    ...
    {
        var source = File.ReadAllText(
            WorkspaceFileLocator.Find("src", "Freexcel.App.Host", "MainWindow.EditingDropdowns.cs"));
    ...
    {
        var source = File.ReadAllText(
            WorkspaceFileLocator.Find("src", "Freexcel.App.Host", "AutoFilterDropdownPlanner.cs"));
    ...
    {
        var source = File.ReadAllText(
            WorkspaceFileLocator.Find("src", "Freexcel.App.Host", "QuickAnalysisPlanner.cs"));
    ...
    public void QuickAnalysisMenu_AnchorsToCellRangeBottomRightCornerOnKeyboardActivation()
    {
        var plannerSource = File.ReadAllText(
            WorkspaceFileLocator.Find("src", "Freexcel.App.Host", "QuickAnalysisMenuPlacementPlanner.cs"));
    ...
    {
        var source = File.ReadAllText(
            WorkspaceFileLocator.Find("src", "Freexcel.App.Host", "RibbonKeyTipOverlayPlacement.cs"));
    ...
    {
        var source = File.ReadAllText(
            WorkspaceFileLocator.Find("src", "Freexcel.App.Host", "MainWindow.KeyboardFocus.cs"));
    ...
    {
        var plannerSource = File.ReadAllText(
            WorkspaceFileLocator.Find("src", "Freexcel.App.Host", "WorksheetContextMenuPlanner.cs"));
    ...
    {
        var source = File.ReadAllText(
            WorkspaceFileLocator.Find("src", "Freexcel.App.Host", "MainWindow.CommandExecution.cs"));
    ...
    public void RepeatLastAction_FillDownAndFillRightAreWiredToRepeatablePaths()
    {
        var homeEditingSource = File.ReadAllText(
            WorkspaceFileLocator.Find("src", "Freexcel.App.Host", "MainWindow.HomeEditing.cs"));
    ...
    {
        var source = File.ReadAllText(
            WorkspaceFileLocator.Find("src", "Freexcel.App.Host", "KeyboardShortcutMatcher.CommandRules.cs"));
    ...
    {
        var source = File.ReadAllText(
            WorkspaceFileLocator.Find("src", "Freexcel.App.Host", "RibbonKeyTipMode.cs"));
    ...
    {
        var source = File.ReadAllText(
            WorkspaceFileLocator.Find("src", "Freexcel.App.Host", "RibbonTopLevelKeyTipRouter.cs"));
