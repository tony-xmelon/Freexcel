...
public static class InsertFunctionCatalogPlanner
{
    ...
    private static readonly HashSet<string> EngineeringFunctions = ["CONVERT", "BIN2DEC", "BIN2HEX", "BIN2OCT", "DEC2BIN", "DEC2HEX", "DEC2OCT", "HEX2BIN", "HEX2DEC", "HEX2OCT", "OCT2BIN", "OCT2DEC", "OCT2HEX", "BITAND", "BITOR", "BITXOR", "BITLSHIFT", "BITRSHIFT", "IMCOS", "IMEXP", "IMLN", "IMLOG10", "IMLOG2", "IMSIN"];
