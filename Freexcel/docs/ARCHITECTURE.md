...
remain explicit parity gaps. The default indexed custom-format palette maps `Color1` through `Color56`; workbook
...
the fixed-document pages directly, and XPS page ranges wrap the renderer's `DocumentPaginator`. Full Excel
