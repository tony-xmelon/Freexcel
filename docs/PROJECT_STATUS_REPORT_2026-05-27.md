...
| C# test files under `tests/` | 383 |
| Markdown docs under `docs/` | 225 |
| Source lines under `src/` | 162,539 |
| Test lines under `tests/` | 144,791 |
| Documentation lines under `docs/` | 26,463 |
| Test methods marked `[Fact]` / `[Theory]` | 6,190 |
