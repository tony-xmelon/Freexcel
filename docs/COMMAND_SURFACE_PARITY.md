...
| Print Preview | Implemented | Honors paper/orientation/margins/headers/print area; preview settings include an access-keyed, non-destructive ignore-print-area option |
...
| Paste Special (values/formulas/formats/transpose/arithmetic/link/column-widths/picture) | Implemented | Supported modes are undoable, validation paste rebases formula-looking relative references, all dialog choices and OK/Cancel expose access keys; external OLE/rich-object paste excluded |
