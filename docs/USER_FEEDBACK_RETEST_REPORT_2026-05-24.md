...
| UT-2026-05-24-006 | Opening a 12 MB workbook with 100+ sheets takes about nine minutes. | Verified resolved for the identified no-formula recalculation path. | Host regression run passed 54/54 including `OpenWorkbookLoaderTests`; 2026-05-25 added `HeavyWorkbookRetestTests` for local Partner Dashboard open smoke coverage. | Original 12 MB workbook is unavailable, so exact reported-file timing is still not benchmarked. |
...
| UT-2026-05-24-014 | Saving the large 12 MB/100+ sheet workbook crashes or hangs indefinitely. | Verified resolved for atomic-save failure protection. | Host regression run passed 54/54 including `SaveWorkbookWriterTests`; 2026-05-25 added `HeavyWorkbookRetestTests` for local Partner Dashboard save smoke coverage. | Original 12 MB workbook is unavailable, so exact reported-file save timing/hang behavior is still not benchmarked. |
