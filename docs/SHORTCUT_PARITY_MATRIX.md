...
8. Expand `Shift+F10` / Menu key toward the remaining full Excel worksheet context menu entries and row/column-selection variants beyond the current command-backed worksheet and active-cell object menus.
